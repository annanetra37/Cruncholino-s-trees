...
export const hy: Messages = {
  ...
  'map.keyRejected':
    'Քարտեզի մատակարարը մերժեց սալիկների հարցումը ({error})։ Սովորաբար բանալին սխալ է, քվոտան սպառված է, կամ բանալին սահմանափակված է այլ դոմենով — ստուգիր NEXT_PUBLIC_MAP_TILES_KEY-ը և թույլատրված դոմենները մատակարարի վահանակում։',
  'map.styleFailed':
    'Հիմնական քարտեզը չբեռնվեց ({error})։ Սալիկները գալիս են openstreetmap.org-ից, ուստի սովորաբար սա ցանցի խնդիր է, ոչ թե կարգավորման։ Էջի մնացած ամեն ինչը շարունակում է աշխատել։',
};
